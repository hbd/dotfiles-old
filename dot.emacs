...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(hl-line ((t (:inherit highlight :background "color-244"))))
 '(web-mode-block-face ((t (:background "brightblue"))) t))
...
(add-to-list 'custom-theme-load-path "/u/zak/.dotfiles/dot.emacs.files/themes/color-theme-molokai")

(add-to-list 'custom-theme-load-path "/u/zak/.dotfiles/dot.emacs.files/themes/monokai-emacs")
